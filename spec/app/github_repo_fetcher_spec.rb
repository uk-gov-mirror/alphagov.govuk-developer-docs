RSpec.describe GitHubRepoFetcher do
  ...
  describe "#nest_docs" do
    it "returns a nested array of docs according to their original dir structure" do
      top_level_doc = { title: "a top level doc", path: "/apps/some-app/foo.html" }
      nested_doc = { title: "a nested doc", path: "/apps/some-app/subdir/bar.html" }
      another_top_level_doc = { title: "another top level doc", path: "/apps/some-app/baz.html" }
      another_nested_doc = { title: "another nested doc", path: "/apps/some-app/another-subdir/something.html" }
      a_deeper_nested_doc = { title: "a deeper nested doc", path: "/apps/some-app/another-subdir/deep/labyrinth.html" }
